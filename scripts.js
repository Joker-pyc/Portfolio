document.addEventListener("DOMContentLoaded", () => {
  const projects = [
    {
      ...
      description:
        "An advanced AI chatbot leveraging the power of Gimini API for natural language processing.",
    ...
    },
    {
      ...
      description:
        "A dynamic platform for e-sports enthusiasts featuring live updates and interactive elements.",
    ...
    },
    {
      ...
      description:
        "A responsive web-based chat application enabling real-time communication.",
    ...
    },
    {
      ...
      description:
        "An intelligent fitness application using AI to create personalized health routines.",
  ...
  const skills = [
    {
      ...
      icon: "fab fa-html5",
      progress: 90,
      details: "Proficient in semantic HTML and accessibility best practices.",
    },
    {
      name: "CSS3",
      icon: "fab fa-css3-alt",
      progress: 85,
      details: "Skilled in responsive design, Flexbox, and CSS Grid.",
    },
    {
      name: "JavaScript",
      icon: "fab fa-js",
      progress: 80,
      details:
        "Strong knowledge of ES6+ features and asynchronous programming.",
    },
    {
      name: "React",
      icon: "fab fa-react",
      progress: 75,
      details: "Experienced in building complex UIs with React and Redux.",
    },
    {
      name: "Node.js",
      icon: "fab fa-node-js",
      progress: 70,
      details: "Capable of building RESTful APIs and server-side applications.",
    },
    {
      name: "Python",
      icon: "fab fa-python",
      progress: 65,
      details: "Proficient in data analysis and machine learning with Python.",
    },
    {
      name: "Git",
      icon: "fab fa-git-alt",
      progress: 80,
      details: "Experienced in version control and collaborative development.",
    },
    {
      name: "Database",
      icon: "fas fa-database",
      progress: 75,
      details: "Skilled in SQL and NoSQL database design and management.",
    },
  ];
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt:
        "Tips and tricks for creating truly responsive and adaptive websites across all devices.",
      image: "assets/blog/responsive-design.jpg",
      link: "#",
      content:
        "Responsive design is more than just media queries. Here's how to take it to the next level...",
    },
    {
      title: "The Rise of JAMstack",
      excerpt:
        "Understanding the benefits and implementation of JAMstack architecture in modern web development.",
      image: "assets/blog/jamstack.jpg",
      link: "#",
      content:
        "JAMstack is changing the way we build and deploy websites. Let's dive into its core principles...",
    },
  ];
  ...
  function setupCustomCursor() {
    ...
    const hoverElements = document.querySelectorAll(
      "a, button, .project-card, .blog-card, .skill-item"
    );
        ...
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            const skill = skills.find(
              (s) =>
                s.name === entry.target.querySelector(".skill-name").textContent
            );
